                      ...
                      tabsetPanel(
                        ...
                        tabPanel("Home",
                                 mainPanel(
                                   ...
                                   h4("Example dataset:",
                                      a("Zoning a field from yield and soil proprieties",
                        ...
                        tabPanel("Depuration",
                                 value = "DepurationTab",
                                 checkboxGroupInput(inputId="AutomaticDep", 
                                                    label=h4("Data depuration"), 
                                                    choices = c(Automatic="Automatico"), 
                                                    inline = TRUE, 
                                                    selected="Automatic",
                                                    width = "10%"),
                                 bsTooltip("AutomaticDep", 
                                 ...
                                 conditionalPanel(condition = "input.AutomaticDep != 'Automatico' ",
                                                  checkboxGroupInput(inputId = "mDepuration", 
                                                                     label = h4("Methods"), 
                                                                     choices = c("Glogal Outliers"="Outliers", 
                                                                                 "Spatial Outliers"="Inliers"), 
                                                                     inline = TRUE,
                                                                     width = "20%"),
                                                  ...
                                                  column(width =4,
                                                         conditionalPanel(
                                                           ...
                                                           bootstrapPage(
                                                             column(width =4,
                                                                    div(
                                                                      ...
                                                                      numericInput(inputId="ylimitmin", 
                                                                                   label="Min", 
                                                                                   value = 0, 
                                                                                   width = "100%"))),
                                                             bsTooltip("ylimitmin", yLimMinDepHelp, 
                                                                       placement = "bottom", 
                                                                       trigger = "hover",
                                                                       options = NULL),
                                                             ...
                                                             column(width =4,
                                                                    div(
                                                                      style="display:inline-block", 
                                                                      numericInput(inputId="ylimitmax", 
                                                                                   label="Max",
                                                                                   value = NA, 
                                                                                   width = "100%"))),
                                                             bsTooltip("ylimitmax", yLimMaxDepHelp, 
                                                                       placement = "bottom", 
                                                                       trigger = "hover",
                                                                       options = NULL)
                                                             ,tags$br()
                                                           ...
                                                           bootstrapPage(
                                                             column(width =5,div(
                                                               style="display:inline-block", 
                                                               numericInput(inputId="DEOut", 
                                                                            label="Standard deviation", 
                                                                            value = 3, width = "100%"))),
                                                             bsTooltip("DEOut",DEOutDepHelp,
                                                                       placement = "bottom", 
                                                                       trigger = "hover",
                                                                       options = NULL)
                                                           ))),
                                                  ...
                                                  ,column(width =4,
                                                          conditionalPanel(
                                                            ...
                                                            bootstrapPage(
                                                              column(width =4,div(
                                                                style="display:inline-block", 
                                                                checkboxInput(inputId="SacoBordes", label="Remove borders", value = 0.0, width = "100%")
                                                              )
                                                              ),
                        ...
                        tabPanel("Prediction",
                                 ...
                                 fluidPage(
                                   column(width = 2,
                                          ...
                                          bsTooltip("bar",AutomaticHelp,
                                                    placement = "bottom", 
                                                    trigger = "hover",
                                                    options = NULL),
                                          
                                          uiOutput("ModelosA"),
                                          checkboxInput('cressie', 'Robust variogram estimate',value=FALSE),
                                          bsTooltip("cressie",CressieHelp,
                                                    placement = "bottom", 
                                                    trigger = "hover",
                                                    options = NULL)
                                          ...
                                          fluidPage(
                                            ...
                                            ,column(width =4,
                                                    div(style="display:inline-block",
                                                        numericInput(inputId="distmax", 
                                                                     label="Max. Dist.", 
                                                                     value =  1000, 
                                                                     width = "80%"),
                                                        bsTooltip("distmax",distmaxKriginHelp,
                                                                  placement = "bottom", 
                                                                  trigger = "hover",
                                                                  options = NULL)
                                                    ))
                                            ,column(width =4,div(style="display:inline-block",
                                                                 numericInput(inputId="block", 
                                                                              label="Block", 
                                                                              value = 0, 
                                                                              width = "80%"),
                                                                 bsTooltip("block",blockKriginHelp,
                                                                           placement = "bottom", 
                                                                           trigger = "hover",
                                                                           options = NULL)
                                            )),
                                            column(width = 3,
                                                   div(style="display:inline-block",
                                                       numericInput("dimGrilla",
                                                                    "Grid dimentions",
                                                                    value= 10, 
                                                                    min=0, 
                                                                    width = "100%"))),
                                            bsTooltip("dimGrilla",dimGrillaKriginHelp,
                                                      placement = "bottom", 
                                                      trigger = "hover",
                                                      options = NULL)
                                          ...
                                          fluidPage(
                                              ...
                                              column(width =2,
                                                     div(style="display:inline-block",
                                                         numericInput(inputId = "min",
                                                                      ...
                                                                      value = NULL,
                                                                      width = "100%")),
                                                     bsTooltip("min",minPredScaleKriginHelp,
                                                               placement = "bottom", 
                                                               trigger = "hover",
                                                               options = NULL)
                                              ),
                                              ...
                                              column(width =2,
                                                     div(style="display:inline-block",
                                                         numericInput(inputId = "max",
                                                                      ...
                                                                      value = NULL, 
                                                                      width = "100%"),
                                                         bsTooltip("max",maxPredScaleKriginHelp,
                                                                   placement = "bottom", 
                                                                   trigger = "hover",
                                                                   options = NULL)
                                            ...
                                            fluidRow(
                                              ...
                                              column(width =2,
                                                     ...
                                                     bsTooltip("min_var",min_varScaleKriginHelp,
                                                               placement = "bottom", 
                                                               trigger = "hover",
                                                               options = NULL)),
                                              column(width =2,
                                                     ...
                                                     bsTooltip("max_var",max_varScaleKriginHelp,
                                                               placement = "bottom", 
                                                               trigger = "hover",
                                                               options = NULL))
                                            )
                                  ...
                                  tabsetPanel(
                                    tabPanel("Parameters for KM-sPC classification",
                                             column(width = 12/3,
                                                    ...
                                                    bsTooltip("centrado", centradoClusterHelp,
                                                              placement = "bottom", 
                                                              trigger = "hover",
                                                              options = NULL),
                                                    bsTooltip("varexplicada",varexplicadaClusterHelp,
                                                              placement = "bottom", 
                                                              trigger = "hover",
                                                              options = NULL),
                                                    bsTooltip("vecindarionulo", vecindarionuloClusterHelp,
                                                              placement = "bottom", 
                                                              trigger = "hover",
                                                              options = NULL),
                                             # ),
                                             # column(width = 12/4,
                                                    bsTooltip("distanciavecino",distanciavecinoClusterHelp,
                                                              placement = "bottom", 
                                                              trigger = "hover",
                                                              options = NULL)
                                             ...
                                             column(width = 12/3,
                                                    ...
                                                    bsTooltip("clusters",clustersClusterHelp,
                                                              placement = "bottom", 
                                                              trigger = "hover",
                                                              options = NULL),
                                                    bsTooltip("distancia", distanciaClusterHelp,
                                                              placement = "bottom", 
                                                              trigger = "hover",
                                                              options = NULL),
                                                    bsTooltip("iteraciones",iteracionesClusterHelp,
                                                              placement = "bottom", 
                                                              trigger = "hover",
                                                              options = NULL),
                                                    bsTooltip("ExpDif",ExpDifClusterHelp,
                                                              placement = "bottom", 
                                                              trigger = "hover",
                                                              options = NULL)
                                    ...
                                    tabPanel("Classification results",
                                             fluidPage(
                                               fluidRow(column(width = 8,
                                                        ...
                                                        column(width = 4,
                                                               plotlyOutput("GraficoResultadosConglom")
                                                        )),
                                               fluidRow(column( width = 8,
                        ...
                        ,tabPanel("Report",
                                  value = "ReportTab",
                                  fluidPage(
                                    p("This section is being developed. It may contain problems when the report is generated. Please, if it happens, contact", a("fastmapping@agro.unc.edu.ar", href = "mailto:fastmapping@agro.unc.edu.ar")),
