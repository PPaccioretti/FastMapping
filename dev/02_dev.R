...
# usethis::use_package("adespatial")
# usethis::use_package("concaveman")
# usethis::use_package("GGally") 
# usethis::use_package("SpatialPack") 
...
usethis::use_data_raw( name = "extra/ExampleData/Barley_Filtering_ss.txt", open = FALSE ) 
usethis::use_data_raw( name = "extra/ExampleData/Wheat_Zoning.txt", open = FALSE ) 
...
## Vignette ----
usethis::use_vignette("FastMapping")
