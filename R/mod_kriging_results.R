        ...
        bslib::layout_columns(
          ...
          },
          {
            bslib::navset_card_pill(
              ...
              bslib::nav_item(btn_dwnd_centered(
                ns("download_predicted_plot"),
                "Download Plot"
              )),
              placement = "below"
            )
          },
          {
            bslib::navset_card_pill(
              ...
              bslib::nav_panel(
                shiny::icon("gear"),
                fillable = FALSE,
                mod_ggplot_options_ui(
                  ns("ggplot_options_var"),
                  pallette_selected = 'cm'
                )
              ),
              bslib::nav_item(btn_dwnd_centered(
                ns("download_variance_plot"),
                "Download Plot"
              )),
              placement = "below"
            )
            ...
            bslib::card(
              ...
              bslib::card_body(
                bslib::layout_columns(
                  ...
                  btn_dwnd_centered(
                    ns("download_pred_tiff"),
                    "Download Tif",
                    style = 'text-align: center; font-size:100%;'
                  ),
                  btn_dwnd_centered(
                    ns("download_pred_gpkg"),
...
#'
#' @noRd
mod_kriging_results_server <- function(
  id,
  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$download_pred_tiff <- downloadHandler(
      ...
      content = function(con) {
        ...
        stars::write_mdim(Predicted_Tiff, con)
