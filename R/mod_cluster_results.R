...
mod_cluster_results_ui <- function(id) {
  ns <- NS(id)
  tagList(
    div(id = ns("noClustered"), p("No cluster process was made.")),
    shinyjs::hidden(div(
      id = ns("yesClustered"),
          ...
          bslib::card_body(
            ...
            bslib::layout_columns(
              ...
              fluidRow(
                ...
                shiny::helpText(
                  "Cluster selection criteria: Lower values indicate better clustering for Summary Index, Xie-Beni and Entropy of Partition indices. ",
                  "For Partition Coefficient, higher values indicate better clustering."
                )
              ),
              bslib::layout_columns(
                col_widths = 12,
                ...
                downloadButton(
                  ns("downloadClasification"),
                  "Download Clasification"
                )
              )
            )
          )
...
#'
#' @noRd
mod_cluster_results_server <- function(
  id,
